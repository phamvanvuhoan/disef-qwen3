...
class CIFAR100(BaseDataModule):
    """LightningDataModule for CIFAR100 dataset.
    ...
    data_url: str = "https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz"
    ...
    def classes(self):
        if not self._classes:
            metadata_fp = Path(self.hparams.artifact_dir, "cifar100", "metadata.csv")
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        metadata_fp = Path(self.hparams.artifact_dir, "cifar100", "metadata.csv")
        split_fp = Path(self.hparams.artifact_dir, "cifar100", "split_coop.csv")
